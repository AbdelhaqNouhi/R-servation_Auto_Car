...
const Footer = () => {
    return (
        <div className='lg:container md:px-16 sm:px-10 mx-auto bg-white shadow-[0_35px_60px_-15px_rgba(0,0,0,1.0)] py-5  bottom-0 flex md:justify-between flex-col gap-6 md:flex-row items-center'>
